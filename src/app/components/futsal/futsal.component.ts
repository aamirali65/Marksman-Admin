...
export class FutsalComponent {
  ...
  submitForm(form: NgForm) {
    this.submitted = true;
    if (form.valid) {
    this.from =  this.selectedOption1+'-'+this.selectedOption2+'-'+this.selectedOption3
    this.to =  this.selectedOption4+'-'+this.selectedOption5+'-'+this.selectedOption6
    console.log('From ' + this.selected_date , this.selectedOption1+'-'+this.selectedOption2+'-'+this.selectedOption3)
    console.log('To ' + this.selected_date , this.selectedOption4+'-'+this.selectedOption5+'-'+this.selectedOption6)
    this.booking = false
    this.resuilt = true
